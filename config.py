...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "8171921953:AAFYzFdOurucshpy88T0Uxx2iP3V_CAT2ns")
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002824204241"))

TG_BOT_WORKERS = int(os.environ.get("TG_BOT_WORKERS", "4"))

#start message
START_MSG = os.environ.get("START_MESSAGE", "<b> Hᴇʟʟᴏ {first}🙌\n\nI ᴀᴍ Rᴊ ᴅᴜʙʙᴇʀ'ꜱ ꜰɪʟᴇ ʙᴏᴛ\nSᴜʙꜱᴄʀɪʙᴇ ᴛᴏ ᴍʏ Cʜᴀɴɴᴇʟ ᴛᴏ ɢᴇᴛ ​ᴇxᴄʟᴜꜱɪᴠᴇ Fɪʟᴇꜱ ☠️\n\nDᴜʙʙᴇᴅ Aɴɪᴍᴇꜱ ~ <a href='https://t.me/+i4xXhurw80w4Y2Rl'>Jᴏɪɴ Hᴇʀᴇ</a>\n\nDᴏɴᴀᴛᴇ ᴜꜱ ~ <a href='https://t.me/RJ_Files_Bot?start=Z2V0LTUyNzEzNzMwNDcxMjIzNA'>Click Me</a>\n\nPᴏᴡᴇʀᴇᴅ ʙʏ <a href='https://t.me/RJ_Dubbers'>Rᴊ Dᴜʙʙᴇʀꜱ🖤</a></b>")
try:
    ADMINS=[]
